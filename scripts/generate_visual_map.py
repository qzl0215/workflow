...
REFERENCE_SPECS = (
    ...
    ("项目初始化", "initialize.md", "条件", "只在兼容代际候选出现时整体改造存量项目"),
)
...
<meta name="description" content="Workflow 3.5 完整改造画面：需求与方案确认、四大核心环节、项目初始化、交付与双层复盘边界。">
...
<!-- 生成文件，请勿手改。真源：SKILL.md、README.md、CHANGELOG.md、十二份 references 与 templates/work.md。 -->
<header class="topbar">
  <div class="shell">
...
<main id="top">
    ...
    <div class="shell hero-grid">
      ...
      <aside class="hero-note">
        ...
        <div class="hero-facts">
          ...
          <div><b>12</b><span>渐进 reference</span></div><div><b>3</b><span>确认凭证类型</span></div>
        </div>
      </aside>
    </div>
  </section>
  ...
  <section class="section" id="architecture">
    <div class="shell">
      ...
      <div class="core-flow">
        <article class="core-card"><span class="num">01 · FRAME</span><h3>目标框定</h3><p>需求澄清覆盖目标、验收和关键取舍；用户确认后才形成契约就绪。</p><code>references/frame.md</code></article>
        <article class="core-card"><span class="num">02 · PLAN</span><h3>结果规划</h3><p>局部 Demo 与完整方案同屏确认；用户看过后说“开动”才形成方案就绪。</p><code>references/plan.md</code></article>
      ...
      <div class="conditional-flow">
        ...
        <article class="conditional-card"><b>条件：经验复盘</b><p>完成陈述后分别检查项目级与 workflow 级更新；双 no-op 直接结束，候选分别确认回灌。</p></article>
      </div>
      <p class="boundary-note"><b>三道确认门：</b>需求澄清 → 需求确认；局部 Demo + 完整文字方案 → 方案确认；完成陈述 → 项目级 / workflow 级回灌确认。简单任务只在 &gt;90% 把握且无承重决策时合并前两门，仍需用户回复。</p>
    </div>
  </section>
  ...
  <section class="section" id="agents">
    <div class="shell">
      <header class="section-head">
        <div><p class="kicker">Demo + Plan → Confirm → Execute</p><h2>先看局部 Demo，再确认完整方案。</h2></div>
        <p class="intro">线框、流程、状态、API、数据或命令演示按任务适配，与完整文字方案在同一次确认中出现；确认前只读调查，演示留在项目外隔离区。</p>
      </header>
      <div class="plan-grid">
    ...
    <div class="shell">
      ...
      <div class="truth-grid">
        ...
        <div class="control-rules">
          <article class="control-rule"><span>01</span><div><b>只存当前投影</b><p>结果契约、确认凭证、计划依赖、状态、已接受证据、阻断和当前就绪责任。</p></div></article>
  ...
  <section class="section">
    <div class="shell">
      ...
      <div class="boundary-grid">
        ...
        <article class="boundary-card is-conditional"><b>Deliver · 条件</b><p>把同一候选写入真实目标，并在真实消费入口冒烟。</p><p>任一步失败就停止并保留现场；宿主拒绝时只按原载荷、目标和后续动作请求可解锁的精确授权。</p></article>
        <article class="boundary-card is-conditional"><b>Learn · 条件</b><p>完成陈述后分别识别项目级更新与 workflow 级更新；每项候选给出证据、影响、最小改动、责任者、验收与不处理代价。</p><p>双 no-op 不要求回复；回灌只建立独立新目标，重新走确认门。</p></article>
      </div>
    ...
    <div class="shell">
      ...
      <div class="status-shell">
        ...
        <div class="status-body">
          ...
          <p><b>进度｜</b><span class="current">■■■■｜■■ · 核心结果完成 · 已完成真实更新 · 项目级 / workflow 级均 no-op</span></p>
  ...
  <section class="section">
    <div class="shell">
      <header class="section-head">
        <div><p class="kicker">十二份渐进路由器</p><h2>每份都从最小动作开始。</h2></div>
